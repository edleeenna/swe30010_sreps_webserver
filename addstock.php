...
?>
   ...
   <form method="" action="">
    ...
    <p> <label for="itemId">Item Id: </label>
      <input type="number" id="itemId" name="itemId"></p>
     <p><label for="itemName">Item Name: </label>
      <input type="text" id="itemName" name="itemName"></p>
       <p><label for="itemDescription">Item Description: </label>
        <input type="text" id="itemDescription" name="itemDescription" ></p>
       <p><label for="directions">Directions: </label>
      <input name="directions" id="directions"></p>
       <p><label for="ingredients">Ingredients: </label>
         <input type="text" id="ingredients" name="ingredients"></p>
